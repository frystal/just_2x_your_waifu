...
def main():
    ...
    output_image_rows = math.ceil(input_image_rows / INPUT_IMAGE_SIZE) * OUTPUT_IMAGE_SIZE
    output_image_cols = math.ceil(input_image_cols / INPUT_IMAGE_SIZE) * OUTPUT_IMAGE_SIZE
    ...
    for y in range(0, input_image_rows, INPUT_IMAGE_SIZE):
        for x in range(0, input_image_cols, INPUT_IMAGE_SIZE):
            test_low_image[0, ...] = input_low_image[y : y + INPUT_IMAGE_SIZE, x : x + INPUT_IMAGE_SIZE, ...]
